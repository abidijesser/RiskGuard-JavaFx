...
public class Assurancevie {
    ...
    public String toString() {
        return "Assurancevie{" + "datedebut=" + datedebut + ", periodevalidation=" + periodevalidation + ", salaireclient=" + salaireclient + ", fichedepaie=" + fichedepaie + ", reponse=" + reponse + ", assurance=" + assurance + '}';
    }
